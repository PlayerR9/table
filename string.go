...
// as it was an array of elements of type string.
//
// Example:
//
//	[ a b c ]
...
func (t *StringTable) Iterator() common.Iterater[string] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []string) common.Iterater[string] {
...
// coordinates return the zero value of type string.
//
// Parameters:
//   - x: The x-coordinate of the cell.
//   - y: The y-coordinate of the cell.
