...
// as it was an array of elements of type uint32.
//
// Example:
//
//	[ a b c ]
...
func (t *Uint32Table) Iterator() common.Iterater[uint32] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []uint32) common.Iterater[uint32] {
...
// coordinates return the zero value of type uint32.
//
// Parameters:
//   - x: The x-coordinate of the cell.
//   - y: The y-coordinate of the cell.
