...
// as it was an array of elements of type complex64.
//
// Example:
//
//	[ a b c ]
...
func (t *Complex64Table) Iterator() common.Iterater[complex64] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []complex64) common.Iterater[complex64] {
...
func (t *Complex64Table) Cleanup() {
	for i := 0; i < t.height; i++ {
		t.table[i] = make([]complex64, t.width)
	}
}
...
func NewComplex64Table(width, height int) *Complex64Table {
	...
	table := make([][]complex64, height)
	for i := 0; i < height; i++ {
		table[i] = make([]complex64, width)
	}
...
// coordinates return the zero value of type complex64.
//
// Parameters:
//   - x: The x-coordinate of the cell.
//   - y: The y-coordinate of the cell.
