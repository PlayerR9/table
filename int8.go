...
// as it was an array of elements of type int8.
//
// Example:
//
//	[ a b c ]
...
func (t *Int8Table) Iterator() common.Iterater[int8] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []int8) common.Iterater[int8] {
...
func NewInt8Table(width, height int) *Int8Table {
	...
	table := make([][]int8, height)
	for i := 0; i < height; i++ {
		table[i] = make([]int8, width)
	}
...
// coordinates return the zero value of type int8.
//
// Parameters:
//   - x: The x-coordinate of the cell.
//   - y: The y-coordinate of the cell.
