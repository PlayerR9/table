...
// as it was an array of elements of type bool.
//
// Example:
//
//	[ a b c ]
...
func (t *BoolTable) Iterator() common.Iterater[bool] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []bool) common.Iterater[bool] {
...
// NewBoolTable creates a new table of type bool with the given width and height.
