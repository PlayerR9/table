...
// as it was an array of elements of type error.
//
// Example:
//
//	[ a b c ]
...
func (t *ErrorTable) Iterator() common.Iterater[error] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []error) common.Iterater[error] {
...
// NewErrorTable creates a new table of type error with the given width and height.
