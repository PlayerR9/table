...
// as it was an array of elements of type int64.
//
// Example:
//
//	[ a b c ]
...
func (t *Int64Table) Iterator() common.Iterater[int64] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []int64) common.Iterater[int64] {
...
// coordinates return the zero value of type int64.
//
// Parameters:
//   - x: The x-coordinate of the cell.
//   - y: The y-coordinate of the cell.
