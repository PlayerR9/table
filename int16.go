...
// as it was an array of elements of type int16.
//
// Example:
//
//	[ a b c ]
...
func (t *Int16Table) Iterator() common.Iterater[int16] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []int16) common.Iterater[int16] {
...
func NewInt16Table(width, height int) *Int16Table {
	...
	table := make([][]int16, height)
	for i := 0; i < height; i++ {
		table[i] = make([]int16, width)
	}
...
// coordinates return the zero value of type int16.
//
// Parameters:
//   - x: The x-coordinate of the cell.
//   - y: The y-coordinate of the cell.
