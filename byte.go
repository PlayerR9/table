...
// as it was an array of elements of type byte.
//
// Example:
//
//	[ a b c ]
...
func (t *ByteTable) Iterator() common.Iterater[byte] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []byte) common.Iterater[byte] {
...
// coordinates return the zero value of type byte.
//
// Parameters:
//   - x: The x-coordinate of the cell.
//   - y: The y-coordinate of the cell.
