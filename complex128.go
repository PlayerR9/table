...
func (t *Complex128Table) Iterator() common.Iterater[complex128] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []complex128) common.Iterater[complex128] {
...
func NewComplex128Table(width, height int) *Complex128Table {
	...
	table := make([][]complex128, height)
	for i := 0; i < height; i++ {
		table[i] = make([]complex128, width)
	}
...
// coordinates return the zero value of type complex128.
//
// Parameters:
//   - x: The x-coordinate of the cell.
//   - y: The y-coordinate of the cell.
