...
// as it was an array of elements of type uint16.
//
// Example:
//
//	[ a b c ]
...
func (t *Uint16Table) Iterator() common.Iterater[uint16] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []uint16) common.Iterater[uint16] {
...
// NewUint16Table creates a new table of type uint16 with the given width and height.
