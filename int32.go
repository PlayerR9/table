...
// as it was an array of elements of type int32.
//
// Example:
//
//	[ a b c ]
...
func (t *Int32Table) Iterator() common.Iterater[int32] {
	iter := common.NewDynamicIterator(
		common.NewSimpleIterator(t.table),
		func(row []int32) common.Iterater[int32] {
...
// coordinates return the zero value of type int32.
//
// Parameters:
//   - x: The x-coordinate of the cell.
//   - y: The y-coordinate of the cell.
